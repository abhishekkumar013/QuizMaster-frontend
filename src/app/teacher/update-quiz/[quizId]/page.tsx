...
export default function UpdateQuizPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`/quiz/teacher/${quizId}`);
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({
      ...prev,
      startTime: toLocalInputFormat(quiz.startTime),
      endTime: toLocalInputFormat(quiz.endTime),
    }));
  }, [quiz]);
  ...
  const handleSubmit = async (isDraft = false) => {
    ...
    try {
      ...
      const res = await axios.put(`/quiz/update/${quizId}`, payload);
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  {/* Add this in your right column section (Step 1) */}
                  <div>
                    <label className="block text-sm font-semibold text-gray-300 mb-2">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-between items-center mt-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <Save className="w-5 h-5" />
                  <span>{isSubmitting ? "Saving..." : "ARCHIVED"}</span>
                </button>
