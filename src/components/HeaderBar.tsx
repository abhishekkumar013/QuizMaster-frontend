  ...
  return (
    <div className="fixed top-0 left-0 w-full flex justify-between items-center px-6 py-3 z-50 ">
      ...
      <Link
        ...
        className=" w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-lg hover:scale-110 transition-transform duration-200"
      >
        <Link
          href={`/update-profile/${user.id}`}
